...
class Relatedtopic extends AppModel {
	...
	public function update_newrelatedtopics($topicid,$new_topci_array,$isnew){
		if(empty($isnew)){
			...
			$insert_query = "insert into relatedtopics value('','".$topicid."','".$new_topci_array[0]."','".$new_topci_array[1]."','".$new_topci_array[2]."','".$new_topci_array[3]."','".$new_topci_array[4]."','".$new_topci_array[5]."','".$new_topci_array[6]."','".$new_topci_array[7]."','".$new_topci_array[8]."','".$new_topci_array[9]."','now()','now()');";

...
//echo "<img src=\"http://www.awltovhc.com/image-6439315-11136360\" width=\"125\" height=\"125\" alt=\"InterNations.org\" border=\"0\"/></a>";
	...
	echo "<div class='span12'>";
		...
		echo "<a href='http://www.facebook.com/sharer.php?u='".Router::url($this->here, true)."class=e'-facebook_link_middle' target='_blank' onclick='var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open(this.href,'sharer','toolbar=0,status=0,width=626,height=256,top='+sTop+',left='+sLeft);return false;'>Share On Facebook</a>";
	echo "</div>";

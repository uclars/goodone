			...
			echo "<div class='row'>";
				...
				echo "<div class='span6' style='text-align:left; line-height:120%; display:table-cell; vertical-align:middle; margin-bottom:25px;'>";	
					echo "<div class='hero-unit'>";
						echo "<p style='line-height:1;'>Hi I'm your avator dog. I'm ".h($me_image['name']).".</p>";
						echo "<p style='line-height:1;'>Your name is shown below.</p>";
						echo "<p style='line-height:1;'>If you don't want to use it, you can change it.</p>";
